      ...
      <section className="flex-1 flex flex-col items-center justify-center py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto mb-16">
            <Link
              to="/host"
              className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl border border-slate-200 transition-all duration-300 hover:-translate-y-1"
            >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Realtime</h3>
              <p className="text-slate-600">Kết quả cập nhật ngay lập tức khi có người bình chọn mới</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Bảo mật</h3>
              <p className="text-slate-600">Mỗi người chỉ được bình chọn một lần, đảm bảo tính công bằng</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Dễ sử dụng</h3>
              <p className="text-slate-600">Giao diện đơn giản, trực quan, không cần đăng ký tài khoản</p>
            </div>
          </div>
        </div>
      </section>
